...
db_name = 'movie_ticketbooking'  # Replace with your database name
    ...
    if request.method == 'POST':
        ...
        if connection:
            ...
            try:
                ...
                print(f"Error fetching movie or storing booking details: {err}", "danger")
                return redirect(url_for('register'))
            finally:
                cursor.close()
                connection.close()
        else:
            print("Failed to connect to the database!", "danger")
            return redirect(url_for('register'))
    ...
    if request.method == 'POST':
        try:
            ...
            if connection:
                ...
                connection.commit()
                print("Seat booking successful!", "success")
